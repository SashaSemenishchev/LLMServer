...
static bool falcon_eval_internal(
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        // self-attention
        {
            ...
            int _n_ctx = configuration->n_max_real_ctx?configuration->n_max_real_ctx:n_ctx;
            Qcur = ggml_rope_inplace(ctx0, Qcur, n_past, head_dim, 2,_n_ctx);
            Kcur = ggml_rope_inplace(ctx0, Kcur, n_past, head_dim, 2,_n_ctx);
